...
<form id="lana-contact-form" method="post" role="form">
	<?php wp_nonce_field( 'send', 'lana_contact_form_nonce_field' ); ?>

    <div class="form-group row">
        <label for="lana-contact-name" class="col-sm-3 col-form-label">
    ...
    <div class="form-group row">
        <label for="lana-contact-email" class="col-sm-3 col-form-label">
    ...
    <div class="form-group row">
        <label for="lana-contact-message" class="col-sm-3 col-form-label">
